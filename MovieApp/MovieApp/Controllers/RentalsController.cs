...
namespace MovieApp.Controllers
{
    public class RentalsController : Controller
    {
        ...
        {
            ViewBag.CustomerID = new SelectList(db.Customers, "CusotmerID", "FirstName");
        ...
        public ActionResult Create([Bind(Include = "RentalID,CustomerID,MovieID,DateRented")] Rental rental)
        {
            ...
            ViewBag.CustomerID = new SelectList(db.Customers, "CusotmerID", "FirstName", rental.CustomerID);
